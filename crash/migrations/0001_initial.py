# Generated by Django 4.2.4 on 2023-09-16 11:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_id', models.CharField(default='', max_length=200)),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users_cash', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('amount_won_by_users', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('amount_lost_by_users', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('float_cash', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('total_cash', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('profit_to_owner', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
