...
DATABASES = {
    'default': {
        ...
        'NAME': 'crashgamedb',  # Replace with your database name
        'USER': 'juma',  # Replace with your database user
        'PASSWORD': 'password',  # Replace with your database password
        'HOST': 'localhost',  # Replace with your database host (e.g., 'localhost')
        'PORT': '5432',  # Replace with your database port (the default is 5432)
    }
}
# DATABASES = {
#     'default': {
